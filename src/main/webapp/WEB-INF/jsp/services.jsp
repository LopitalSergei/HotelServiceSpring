        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6">
                <div class="services-item">
                    <div class="si-pic set-bg" data-setbg="${contextPath}/resources/img/services/service-1.jpg">
                        <div class="service-icon">
                            <img src="${contextPath}/resources/img/services/service-icon-1.png" alt="">
                        </div>
                    </div>
                    <div class="si-text">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="services-item">
                    <div class="si-pic set-bg" data-setbg="${contextPath}/resources/img/services/service-10.jpg">
                        <div class="service-icon">
                            <img src="${contextPath}/resources/img/services/service-icon-2.png" alt="">
                        </div>
                    </div>
                    <div class="si-text">
                        <h3>Фитнес-Центр</h3>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="services-item">
                    <div class="si-pic set-bg" data-setbg="${contextPath}/resources/img/services/service-11.jpg">
                        <div class="service-icon">
                            <img src="${contextPath}/resources/img/services/service-icon-3.png" alt="">
                        </div>
                    </div>
                    <div class="si-text">
                        <h3>Трансфер</h3>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="services-item">
                    <div class="si-pic set-bg" data-setbg="${contextPath}/resources/img/services/service-4.jpg">
                        <div class="service-icon">
                            <img src="${contextPath}/resources/img/services/service-icon-4.png" alt="">
                        </div>
                    </div>
                    <div class="si-text">
                        <h3>Ресторан</h3>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="services-item">
                    <div class="si-pic set-bg" data-setbg="${contextPath}/resources/img/services/service-12.jpg">
                        <div class="service-icon">
                            <img src="${contextPath}/resources/img/services/service-icon-5.png" alt="">
                        </div>
                    </div>
                    <div class="si-text">
                        <h3>Городской Гид</h3>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="services-item">
                    <div class="si-pic set-bg" data-setbg="${contextPath}/resources/img/services/service-6.jpg">
                        <div class="service-icon">
                            <img src="${contextPath}/resources/img/services/service-icon-6.png" alt="">
                        </div>
                    </div>
                    <div class="si-text">
                        <h3>Однодневные Путешествия</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                            ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida.</p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="services-item">
                    <div class="si-pic set-bg" data-setbg="${contextPath}/resources/img/services/service-7.jpg">
                        <div class="service-icon">
                            <img src="${contextPath}/resources/img/services/service-icon-7.png" alt="">
                        </div>
                    </div>
                    <div class="si-text">
                        <h3>Спа & Сауна</h3>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="services-item">
                    <div class="si-pic set-bg" data-setbg="${contextPath}/resources/img/services/service-8.jpg">
                        <div class="service-icon">
                            <img src="${contextPath}/resources/img/services/service-icon-8.png" alt="">
                        </div>
                    </div>
                    <div class="si-text">
                        <h3>Подводное Плавание</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                            ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida.</p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="services-item">
                    <div class="si-pic set-bg" data-setbg="${contextPath}/resources/img/services/service-9.jpg">
                        <div class="service-icon">
                            <img src="${contextPath}/resources/img/services/service-icon-9.png" alt="">
                        </div>
                    </div>
                    <div class="si-text">
                        <h3>Частный Гид</h3>
...
<section class="kids-section">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6">
                <div class="kid-pic">
                    <img src="${contextPath}/resources/img/services/kid-img.png" alt="">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="kid-text">
                    ...
                    <a href="/request" class="primary-btn">Сделайте предварительный заказ</a>
                </div>
            </div>
        </div>
    </div>
